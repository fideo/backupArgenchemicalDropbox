...
directorio_destino = '/home/administrador/Dropbox/backups/argenchemical/'
...
for zip, _ in archivos_destino:
    ...
    os.chown("/home/administrador/Dropbox/backups/argenchemical/"+str(zip), 1000, 1000)  # UID y GID del usuario administrador


########### DEJO LOS DOS ARCHIVOS MAS NUEVOS DE LA BASE ARGENCHEMICAL ###########
