...
####### BACKUP ARGENCHEMICAL ########

# Directorio de origen y destino
directorio_origen = '/mnt/disco2/home/administrador/respaldos/argenchemical/'
directorio_destino = '/home/administrador/Dropbox/backups/'
...
for zip, _ in archivos_destino:
    ...
    os.chown("/home/administrador/Dropbox/backups/"+str(zip), 1000, 1000)  # UID y GID del usuario administrador


########### DEJO LOS DOS ARCHIVOS MAS NUEVOS ###########

# Eliminar los archivos más antiguos en el directorio de origen
for nombre, _ in archivos_destino[4:]:
